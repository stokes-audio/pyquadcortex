...
def example_cab(cat: catalog.ModelCatalog) -> str:
    ...
    return f"models.{generate_models.class_name(cab.category)}.{generate_models.const_name(cab.name)}"
...
def render(cat: catalog.ModelCatalog, snapshot: str) -> str:
    lines = [
        ...
        "",
        f"GENERATED by scripts/generate_params.py --snapshot {snapshot} - do not edit by hand.",
        "",
