#!/usr/bin/env python3
"""Generate ``pyquadcortex/protocol/params.py`` - a firmware catalog snapshot.
...
def render(cat: catalog.ModelCatalog) -> str:
    lines = [
        '"""Parameter constants generated from one firmware\'s factory catalog.',
        "",
        ...
        "",
        "    cab = Block(0, 5, models.CabsimBassM.N212_DOUGLAS_NEODYMIUM_M)",
        "    qc.set_block(cab)",
        ...
        "",
        "This file is a firmware-specific snapshot. Only FACTORY content is here,",
        "as in `models.py`. Resolve anything else",
        "through ``qc.catalog``.",
        '"""',
