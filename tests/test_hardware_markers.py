...
UNMARKED_OPERATIONS = {
    "tap_screen": "wire sequence and coordinate validation are pinned offline; the live test is manual because a tap changes the owner's current screen and has no reliable protocol restore",
